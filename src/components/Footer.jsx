    ...
    <footer className="bg-black text-gray-400 py-8 mt-10">
      <div className="container mx-auto px-6 md:px-12 lg:px-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          Ferrari es una de las marcas más icónicas del mundo automovilístico, reconocida por su innovación, 
  diseño y alto rendimiento. Desde su fundación en 1939, ha sido sinónimo de velocidad, lujo y pasión 
  por la competición.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col space-y-2">
            ...
            <Link to="/cars" className="hover:text-white transition duration-200">Coches</Link>
            <Link to="/gallery" className="hover:text-white transition duration-200">Galería</Link>
          </div>
        </div>
